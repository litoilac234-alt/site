-- Railway MySQL install (database is already named "railway")
-- Paste this entire file into Railway → MySQL → Database → Data → Run
...
INSERT INTO users (email, password_hash, full_name, role) VALUES
  ('engineer1@peo.local', '$2y$10$JDu8WYu/gOXCaDtjRiloW.YdHHztR2PbHWhQ1buoKpCTU58skjh2K', 'Engr. Juan Dela Cruz', 'engineer_1'),
  ('engineer2@peo.local', '$2y$10$JDu8WYu/gOXCaDtjRiloW.YdHHztR2PbHWhQ1buoKpCTU58skjh2K', 'Engr. Maria Santos', 'engineer_2'),
  ('engineer3@peo.local', '$2y$10$JDu8WYu/gOXCaDtjRiloW.YdHHztR2PbHWhQ1buoKpCTU58skjh2K', 'Engr. Pedro Reyes', 'engineer_3'),
  ('engineer4@peo.local', '$2y$10$JDu8WYu/gOXCaDtjRiloW.YdHHztR2PbHWhQ1buoKpCTU58skjh2K', 'Engr. Ana Lopez', 'engineer_4'),
  ('contractor@build.local', '$2y$10$JDu8WYu/gOXCaDtjRiloW.YdHHztR2PbHWhQ1buoKpCTU58skjh2K', 'ABC Construction Corp.', 'contractor');
